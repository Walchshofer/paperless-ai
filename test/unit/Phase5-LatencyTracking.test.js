...
describe('Phase 5 Latency Tracking', function() {
    it('should record pipeline stage latency', async function() {
        ...
        assert.ok(
            output.includes('pipeline_stage_latency_ms_count{stage_name="stage-ocr",stage_type="TEXT_EXTRACTION"}'),
    ...
    it('should record visual query execution time', async function() {
        ...
        assert.ok(
            output.includes('visual_query_execution_time_ms_count{document_type="financial"}'),
