...
OLLAMA_MODEL_MEDICAL=medical-model:latest
...
class OllamaService {
    ...
    _calculateNumCtx(promptTokenCount, responseTokens, modelName = null) {
        ...
        if (modelName) {
            if (modelName.includes('medical-model') || modelName.includes('medalpaca')) {
...
OLLAMA_MODEL_MEDICAL=medical-model:latest         # 4GB
