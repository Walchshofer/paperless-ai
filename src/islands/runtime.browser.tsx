...
import SettingsHeaderIsland from './SettingsHeaderIsland';
...
import PromptsSettingsIsland from './PromptsSettingsIsland';
...
import SaveCoordinatorIsland from './SaveCoordinatorIsland';
...
import type { PromptsSettings } from '../ui/contracts/Settings.Prompts.contract';
...
type IslandPropsMap = {
  ...
  'settings-header-island': Partial<SettingsHeaderProps>;
  ...
  'prompts-settings-island': Partial<PromptsSettings>;
  ...
  'save-coordinator-island': { documentId?: number };
...
registerIsland('settings-header-island', SettingsHeaderIsland);
...
registerIsland('prompts-settings-island', PromptsSettingsIsland);
...
registerIsland('save-coordinator-island', SaveCoordinatorIsland);
