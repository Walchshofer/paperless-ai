...
class DocumentProcessor {
    ...
    async _processLegacyVision(document, options) {
        ...
        // Prepare document for legacy processing
        const legacyDoc = {
            id: document.id,
        ...
        const result = await vision.processDocument(legacyDoc, options);
    ...
    async _processLegacyText(document, options) {
        ...
        const result = await text.processDocument(legacyDoc, options);
    ...
    async healthCheck() {
        ...
        try {
            ...
            if (response.ok) {
                ...
                health.components.ollama = { status: 'unhealthy', error: 'Bad response' };
