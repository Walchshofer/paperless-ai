...
const FinancialPipeline = {
    ...
    stages: [
        ...
        },
        {
            ...
            model: process.env.FINANCE_GENERAL_MODEL || 'llm-pro-finance-8b',
            modelType: ModelType.TEXT_ONLY,
            executionMode: ExecutionMode.SEQUENTIAL,
            inputMapping: {
                text_chunk: 'document.ocr_text',
        ...
        },
        {
            ...
            model: process.env.FINANCE_REASONING_MODEL || 'fino1-8b',
            modelType: ModelType.TEXT_ONLY,
            executionMode: ExecutionMode.SEQUENTIAL,
            inputMapping: {
        ...
        },
        {
            ...
            model: process.env.VAT_EXPERT_MODEL || process.env.FINANCE_GENERAL_MODEL || 'llm-pro-finance-8b',
            modelType: ModelType.TEXT_ONLY,
            executionMode: ExecutionMode.CONDITIONAL,
            condition: {
